...
filterValues:: [[String]]
filterValues = map (removeBlankVotes) sortVotes
...
cleanVotes = map (zipVote (head dirtyVotes)) (drop 1 dirtyVotes) 

zipVote :: [String] -> [String] -> [(String, String)]
zipVote candidates vote = trace("\n") zip (drop 2 candidates) (drop 2 vote)
